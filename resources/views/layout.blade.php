...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <a class="navbar-brand m-0" >
        ...
        {{-- jika pengguna terautentikasi sebagai admin, akan menampilkan pesan "Hai, [nama admin]".  --}}
        @if (Auth::guard('admin')->check())
        <span class="font-weight-bold text-white mt-5">
            Hai, {{ Auth::guard('admin')->user()->nama }}
        </span>
        {{-- Jika terautentikasi sebagai pembimbing, pesan akan menampilkan "Hai, [nama pembimbing]" --}}
